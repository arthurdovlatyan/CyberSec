...
response.setHeader("SET-COOKIE","JSESSIONID="+sessionid+";HttpOnly"+";SameSite=strict"+";Secure=true");
	//	} 
	//} 

//String sessionid = request.getSession().getId();  
//response.setHeader("SET-COOKIE","JSESSIONID="+ //sessionid+";HttpOnly"+";SameSite=strict"+";secure");
%> 
