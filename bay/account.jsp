...
<%
	...
	username = StringUtils.replace(username, "<", "&lt");
	username = StringUtils.replace(username, "\"", "&quot");
	
	password = StringUtils.replace(password, "<", "&lt");
	password = StringUtils.replace(password, "\"", "&quot");
	
	password2 = StringUtils.replace(password2, "<", "&lt");
	password2 = StringUtils.replace(password2, "\"", "&quot");
